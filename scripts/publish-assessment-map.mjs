...
const ASSESSMENT_TYPES = new Set(['daily', 'weekly', 'monthly', 'pro', 'homework']);
...
export function sanitizeQuestionMap(input) {
  ...
  if (!ASSESSMENT_TYPES.has(assessmentType)) fail('INVALID_QUESTION_MAP', 'assessment_type 必须是 daily / weekly / monthly / pro / homework');
